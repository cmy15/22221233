...
class Friendship(Base):
    ...
    # Primary keys are composite of the two usernames
...
class FriendRequest(Base):
    ...
    sender = Column(String, primary_key=True, nullable=False)
    receiver = Column(String, primary_key=True, nullable=False)
